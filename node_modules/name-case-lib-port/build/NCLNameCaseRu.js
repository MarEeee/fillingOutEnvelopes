...
var NCLNameCaseRu = function (_NCLNameCaseCore) {
    _inherits(NCLNameCaseRu, _NCLNameCaseCore);

    function NCLNameCaseRu() {
        _classCallCheck(this, NCLNameCaseRu);

        /**
         * Версия языкового файла
         * @var string 
         */
        var _this = _possibleConstructorReturn(this, (NCLNameCaseRu.__proto__ || Object.getPrototypeOf(NCLNameCaseRu)).call(this));

        _this._languageBuild = '11072716';
        /**
         ...
         * @var array 
         */
        _this.ovo = ['ово', 'аго', 'яго', 'ирь'];
        /**
         * Окончания имен/фамилий, который не склоняются
         * @var array 
         */
        _this.ih = ['их', 'ых', 'ко', 'уа' /*Бенуа, Франсуа*/];
        /**
        ...
        _this.names_man = ['Вова', 'Анри', 'Питер', 'Пауль', 'Франц', 'Вильям', 'Уильям', 'Альфонс', 'Ганс', 'Франс', 'Филиппо', 'Андреа', 'Корнелис', 'Фрэнк', 'Леонардо', 'Джеймс', 'Отто', 'жан-пьер', 'Джованни', 'Джозеф', 'Педро', 'Адольф', 'Уолтер', 'Антонио', 'Якоб', 'Эсташ', 'Адрианс', 'Франческо', 'Доменико', 'Ханс', 'Гун', 'Шарль', 'Хендрик', 'Амброзиус', 'Таддео', 'Фердинанд', 'Джошуа', 'Изак', 'Иоганн', 'Фридрих', 'Эмиль', 'Умберто', 'Франсуа', 'Ян', 'Эрнст', 'Георг', 'Карл'];
        return _this;
    }
    ...
    _createClass(NCLNameCaseRu, [{
        ...
        value: function detectNamePart( /*NCLNameCaseWord*/word) {
            ...
            var length = _NCLStr2.default.strlen(namepart);
            ...
            //Исключения
            if (this.inNames(namepart, ['Лев', 'Яков', 'Вова', 'Маша', 'Ольга', 'Еремей', 'Исак', 'Исаак', 'Ева', 'Ирина', 'Элькин', 'Мерлин', 'Макс', 'Алекс', 'Мариа' /*Альфонс Мариа Муха*/
    ...
    return NCLNameCaseRu;
}(_NCLNameCaseCore3.default);

exports.default = NCLNameCaseRu;